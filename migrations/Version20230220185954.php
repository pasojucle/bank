...
final class Version20230220185954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE schedule (id INT AUTO_INCREMENT NOT NULL, label_id INT DEFAULT NULL, category_id INT DEFAULT NULL, debit_account_id INT DEFAULT NULL, credit_account_id INT DEFAULT NULL, deadline_day INT NOT NULL, end_at DATE DEFAULT NULL, amount INT NOT NULL, INDEX IDX_5A3811FB33B92F39 (label_id), INDEX IDX_5A3811FB12469DE2 (category_id), INDEX IDX_5A3811FB204C4EAA (debit_account_id), INDEX IDX_5A3811FB6813E404 (credit_account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE schedule_month (schedule_id INT NOT NULL, month_id INT NOT NULL, INDEX IDX_72EFD05AA40BC2D5 (schedule_id), INDEX IDX_72EFD05AA0CBDE4 (month_id), PRIMARY KEY(schedule_id, month_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE schedule ADD CONSTRAINT FK_5A3811FB33B92F39 FOREIGN KEY (label_id) REFERENCES label (id)');
        $this->addSql('ALTER TABLE schedule ADD CONSTRAINT FK_5A3811FB12469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('ALTER TABLE schedule ADD CONSTRAINT FK_5A3811FB204C4EAA FOREIGN KEY (debit_account_id) REFERENCES account (id)');
        $this->addSql('ALTER TABLE schedule ADD CONSTRAINT FK_5A3811FB6813E404 FOREIGN KEY (credit_account_id) REFERENCES account (id)');
        $this->addSql('ALTER TABLE schedule_month ADD CONSTRAINT FK_72EFD05AA40BC2D5 FOREIGN KEY (schedule_id) REFERENCES schedule (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE schedule_month ADD CONSTRAINT FK_72EFD05AA0CBDE4 FOREIGN KEY (month_id) REFERENCES month (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE schedule DROP FOREIGN KEY FK_5A3811FB33B92F39');
        $this->addSql('ALTER TABLE schedule DROP FOREIGN KEY FK_5A3811FB12469DE2');
        $this->addSql('ALTER TABLE schedule DROP FOREIGN KEY FK_5A3811FB204C4EAA');
        $this->addSql('ALTER TABLE schedule DROP FOREIGN KEY FK_5A3811FB6813E404');
        $this->addSql('ALTER TABLE schedule_month DROP FOREIGN KEY FK_72EFD05AA40BC2D5');
        $this->addSql('ALTER TABLE schedule_month DROP FOREIGN KEY FK_72EFD05AA0CBDE4');
        ...
        $this->addSql('DROP TABLE schedule_month');
